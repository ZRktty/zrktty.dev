    ...
    <section className="py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 border border-border dark:border-ink-border">
        {cells.map((cell, i) => (
          ...
          >
            <p className="font-jetbrains-mono text-[11px] uppercase tracking-widest text-muted-foreground dark:text-ink-muted mb-4">
              {cell.number} / {cell.title}
            </p>
            <p className="text-[14px] text-foreground dark:text-ink-text leading-relaxed flex-1 mb-6">
              {cell.body}
            </p>
            <p className="font-jetbrains-mono text-[10.5px] text-muted-foreground dark:text-ink-muted border-t border-border dark:border-ink-border pt-3">
              {cell.tag}
            </p>
          </div>
        ))}
