...
export function Testimonial() {
  return (
    <section className="py-16 md:py-24 bg-[#0A0A0A] -mx-4 md:-mx-6 lg:-mx-8 px-4 md:px-6 lg:px-8">
      <blockquote className="max-w-[580px]">
        <p className="font-vin-pro-mono text-[17px] text-white leading-relaxed mb-8">
        ...
        <footer className="flex items-center gap-3">
          ...
          <span className="font-vin-pro-mono text-[11.5px] uppercase tracking-widest text-ink-muted">
            CTO, [Company] · 2025
          </span>
        </footer>
      </blockquote>
