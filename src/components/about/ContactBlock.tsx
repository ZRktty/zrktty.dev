      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-16 mb-12 max-w-[640px]">
        <div className="flex flex-col gap-3">
          {fits.map((line) => (
            <p
              key={line}
              className="font-jetbrains-mono text-[13px] text-foreground dark:text-ink-text"
            >
        ...
        <div className="flex flex-col gap-3">
          {notFits.map((line) => (
            <p
              key={line}
              className="font-jetbrains-mono text-[13px] text-muted-foreground dark:text-ink-muted"
            >
